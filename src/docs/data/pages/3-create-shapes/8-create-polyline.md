## How to create SVG Polyline

The **createPolyline()** function is used to create an SVG polyline element.

```js
import { createPolyline } from 'mz-svg';
...
```js
import { createPolyline } from 'mz-svg/dist/mz-svg.node.cjs';
